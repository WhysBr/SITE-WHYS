  ...
  (
    ...
    return (
      <motion.div
        ...
        className={cn(
          "relative h-[26rem] w-80 rounded-2xl bg-transparent shadow-2xl border border-foreground/10",
          className
        )}
      >
        <div
        ...
        >
          ...
          <div className="absolute inset-0 h-full w-full rounded-xl bg-gradient-to-b from-black/0 via-transparent to-black/90" />
