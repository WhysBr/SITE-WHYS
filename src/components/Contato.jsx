...
export default function Contato() {
  return (
    <section id="contato" className="w-full py-24 flex flex-col lg:flex-row gap-16 lg:gap-24 justify-between items-start">
      
      {/* Esquerda: Informações de Contato */}
      <div className="w-full lg:w-[55%] flex flex-col">
        <span className="text-sm font-medium tracking-wider mb-6 text-foreground/70">/ entre em contato /</span>
        
        <h2 className="text-5xl md:text-6xl font-medium tracking-tight mb-8 leading-[1.1]">
          Estamos sempre prontos para ajudá-lo e tirar suas dúvidas
        </h2>
        
        <p className="text-foreground/70 text-lg mb-16 max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            <Phone className="w-6 h-6 mb-4 text-foreground/80 stroke-[1.5]" />
            <h3 className="text-xl font-medium mb-4">Central de Atendimento</h3>
          ...
          {/* Location */}
          <div className="flex flex-col">
            <MapPin className="w-6 h-6 mb-4 text-foreground/80 stroke-[1.5]" />
            <h3 className="text-xl font-medium mb-4">Nossa Localização</h3>
          ...
          {/* Email */}
          <div className="flex flex-col">
            <Mail className="w-6 h-6 mb-4 text-foreground/80 stroke-[1.5]" />
            <h3 className="text-xl font-medium mb-4">E-mail</h3>
          ...
          {/* Social Network */}
          <div className="flex flex-col">
            <Share2 className="w-6 h-6 mb-4 text-foreground/80 stroke-[1.5]" />
            <h3 className="text-xl font-medium mb-4">Redes Sociais</h3>
            <div className="flex items-center gap-4 text-foreground/70">
              <a href="#" className="hover:text-[#965EC7] transition-colors"><FacebookIcon className="w-5 h-5 stroke-[1.5]" /></a>
              <a href="#" className="hover:text-[#965EC7] transition-colors"><TwitterIcon className="w-5 h-5 stroke-[1.5]" /></a>
              <a href="#" className="hover:text-[#965EC7] transition-colors"><LinkedinIcon className="w-5 h-5 stroke-[1.5]" /></a>
              <a href="#" className="hover:text-[#965EC7] transition-colors"><YoutubeIcon className="w-5 h-5 stroke-[1.5]" /></a>
              <a href="#" className="hover:text-[#965EC7] transition-colors"><GithubIcon className="w-5 h-5 stroke-[1.5]" /></a>
            </div>
          </div>
      ...
      <div className="w-full lg:w-[40%] flex flex-col mt-4 lg:mt-0">
        <h3 className="text-3xl font-medium mb-4">Entre em Contato</h3>
        <p className="text-foreground/70 text-sm mb-12">
        ...
        <form className="flex flex-col gap-8 w-full" onSubmit={(e) => e.preventDefault()}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center gap-3 bg-foreground text-background rounded-full py-4 px-8 w-fit mt-4 text-sm font-medium transition-all hover:bg-foreground/90 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            Enviar mensagem
